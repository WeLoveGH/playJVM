...
public class Test15_2 {
    ...
    private static Test15_2 test15 = new Test15_2();
...
2: false
3: true
[GC (System.gc())  2918K->832K(184832K), 0.0080651 secs]
[Full GC (System.gc())  832K->735K(184832K), 0.0209254 secs]
GC 时，会调用 finalize()
GC 时，会调用 finalize() —— 从日志可以看到，调用了两次 finalize() 方法，这是为什么？ 原来 GC 每次回收一个垃圾对象时都会调用一次 finalize() 方法
4: false
