...
public class Test15_3 {
    ...
    private static Test15_3 test15 = null;
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        /**
         * 注意，这里构建了三个对象，一次 GC 会同时回收掉这三个垃圾对象，并且会掉用三次 finalize() 方法
         */
        test15 = new Test15_3();
        test15 = new Test15_3();
        test15 = new Test15_3();
...
2: false
3: true
[GC (System.gc())  2918K->800K(184832K), 0.0107170 secs]
[Full GC (System.gc())  800K->735K(184832K), 0.0332346 secs]
GC 时，会调用 finalize()
GC 时，会调用 finalize()
GC 时，会调用 finalize()
4: false
